...
//require('dotenv').config(); //react / heroku - didn´t solve the issue
...
//gSystemConfig.configAPIURL = process.env.REACT_APP_CONFIG_API_URL; //gSystemConfig.configSystemURLSSL | process.env.CONFIG_API_URL;
