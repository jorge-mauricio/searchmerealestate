...
class FrontendContentListing extends Component
{
    ...
    async build()
    {
        ...
        try
        {
            ...
            apiURLCategoriesDetailsCurrent = gSystemConfig.configAPIURL + "/" + gSystemConfig.configRouteAPI + "/" + gSystemConfig.configRouteAPICategories + "/" + this._idParentContent + "?apiKey=createSecretPassword";
