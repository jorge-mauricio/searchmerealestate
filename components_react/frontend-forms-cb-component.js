...
class FrontendForms extends Component
{
    ...
    async build()
    {
        ...
        try
        {
            ...
            apiURLFormsDetails = gSystemConfig.configAPIURL + "/" + gSystemConfig.configRouteAPI + "/" + gSystemConfig.configRouteAPIForms + "/" + gSystemConfig.configRouteAPIDetails + "/" + this.idTbForms + "/?apiKey=createSecretPassword";
