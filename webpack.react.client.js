...
module.exports = {
    ...
    //target: "web",
    //context: path.resolve(__dirname, gSystemConfig.configDirectoryBuildReact + "/" + gSystemConfig.configDirectoryBuildReactClient), //error
